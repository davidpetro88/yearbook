...
class Home_Model_Mapper_UsersMapper {
    ...
    public function diretoryImg($diretory) {
        ...
        $diretoryImg = explode('yearbook\public', $diretory);

        $diretoryRelace = str_replace("\\", '/', $diretoryImg[1]);

        return $diretoryRelace;
    }
                ...
                if (!empty($fetchByUsername)) {
                    ...
                    if (!empty($dados['image'])) {
                        ...
                        if (!empty($image)) {
                            ...
                            $arrayInsert = array('username' => $dados['username'],
